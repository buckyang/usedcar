<div class="register">
    ...
    <form action="/register" method="post">
        ...
        <div class="seller-name">
            ...
            <label class="seller-type"><input type="radio" name="company" value="company"/>二手车经济公司</label>
            <label class="seller-type"><input type="radio" name="company" value="4s"/>4S店</label>
        </div>
