...
<form:form modelAttribute="bindPhoneDTO" method="post"
	action="validBindedPhone">
	<table border="0" width="100%">
		<tbody>
			<tr>
				<td width="150" class="right" valign="top">手机号码：</td>
				<td><form:input id="bindedPhoneNumber" path="phoneNumber" readonly="true" value="${bindPhoneDTO.phoneNumber }"/></td>
				<td><a href="javascript:void(0);" onclick="sendMessage('bindedPhoneNumber','7');" style="color: #000000;">获取验证码</a></td> 
